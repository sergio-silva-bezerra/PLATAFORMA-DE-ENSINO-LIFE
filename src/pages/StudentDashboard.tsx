...
export function StudentDashboard() {
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-8 pb-24">
      ...
      {/* Banner */}
      <div className="relative bg-[#E31E24] rounded-lg overflow-hidden h-[240px] flex items-center px-12 group">
        <div className="z-10 space-y-4 max-w-md">
          ...
          <button className="bg-[#4CAF50] text-white px-8 py-2.5 rounded font-bold text-xs uppercase tracking-wider hover:bg-[#43a047] transition-colors shadow-lg">
            INICIAR PASSEIO
          </button>
        </div>
      ...
      {/* Timeline */}
      <div className="flex items-center justify-between px-4 py-2 bg-white rounded-full border border-gray-100 shadow-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pt-4">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link to="/aluno/carteira/pagamentos" className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all group">
              <div className="flex items-center gap-3 mb-3">
                <div className="p-2 bg-red-50 text-[#E31E24] rounded-lg group-hover:bg-[#E31E24] group-hover:text-white transition-colors">
            ...
            <Link to="/aluno/secretaria?type=acompanhar-chamados" className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all group">
              <div className="flex items-center gap-3 mb-3">
            ...
            <Link to="/aluno/sala-virtual" className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all group">
              <div className="flex items-center gap-3 mb-3">
          ...
          {subjects.map((subject) => (
            <div key={subject.id} className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
              <div className="p-6 flex justify-between items-start">
                <div className="space-y-4 flex-1">
                  ...
                  <Link 
                    ...
                    className="flex items-center gap-2 px-4 py-2 border border-[#E31E24] text-[#E31E24] rounded-md text-xs font-bold hover:bg-[#E31E24]/5 transition-colors w-fit"
                  >
                    <div className="p-1 bg-[#E31E24]/10 rounded">
                ...
                <div className="flex flex-col items-center gap-1">
                   <div className="w-16 h-16 bg-gray-50 border border-gray-100 rounded flex flex-col items-center justify-center">
        ...
        <div className="space-y-6">
            ...
            <div className="p-8 flex flex-col items-center text-center space-y-4">
               <div className="relative">
                  ...
                  <div className="absolute -bottom-1 -right-1 bg-white p-1 rounded-full shadow-sm">
                    <div className="bg-amber-400 w-4 h-4 rounded-full flex items-center justify-center text-white text-[8px] font-bold">$</div>
                  </div>
               </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div className="p-4 space-y-3">
              <Link to="/aluno/secretaria" className="flex items-center gap-3 p-3 rounded-xl hover:bg-blue-50 transition-colors group border border-transparent hover:border-blue-100">
              ...
              <Link to="/aluno/carteira/pagamentos" className="flex items-center gap-3 p-3 rounded-xl hover:bg-green-50 transition-colors group border border-transparent hover:border-green-100">
                <div className="p-2 bg-red-100 rounded-lg text-[#E31E24] group-hover:bg-[#E31E24] group-hover:text-white transition-colors">
                  <ExternalLink className="w-4 h-4" />
                </div>
                <div>
              ...
              <Link to="/aluno/sala-virtual" className="flex items-center gap-3 p-3 rounded-xl hover:bg-purple-50 transition-colors group border border-transparent hover:border-purple-100">
