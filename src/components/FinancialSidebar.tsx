...
const navItems = [
  ...
  { icon: DollarSign, label: 'Pagamentos', path: '/financeiro/pagamentos' },
  { icon: ArrowRightLeft, label: 'Negociações', path: '/financeiro/negociacoes' },
    ...
    <aside className="w-64 bg-white border-r border-gray-200 flex flex-col h-screen sticky top-0">
      <div className="p-6 flex items-center gap-3 border-b border-gray-100">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-[10px] font-bold text-[#E31E24] uppercase tracking-widest">Financeiro</span>
        </div>
      </div>
